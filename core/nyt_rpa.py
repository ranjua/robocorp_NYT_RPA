...
class NYT_RPA():
    ...
    def __init__(self, screenshot_directory, implicit_wait=30, timeout=30, speed=0, auto_close=True, **config):
    ...
    def get_news_from(self, search_phrase: str, max_retries=3):
        ...
        while retry_count < max_retries:
            try:
                ...
                if self.set_parameters_for_search(self.start_date, self.end_date, self.sections, self.types) == 2:
    ...
    def basic_search(self, search_phrase: str):
        if self.browser.does_page_contain_element(Locators_NYT.ICON_BASIC_SEARCH):
            ...
            self.browser.input_text_when_element_is_visible(Locators_NYT.TXT_BASIC_SEARCH, search_phrase)
            ...
            #mobile vesion
            self.browser.click_element(Locators_NYT.ICON_BASIC_SEARCH)
            self.browser.input_text_when_element_is_visible(Locators_NYT.TXT_BASIC_SEARCH_MOBILE, search_phrase)
    ...
    def extract_info(self, search_phrase: str):
        ...
        for news in list_of_news:
            ...
            try:
                ...
                picture_filename = "output/" + \
                    helpers.clean_string_for_filename(title) + "_" + \
    ...
    def find_element_safe(self, locator, parent):
        try:
            webElement = self.browser.find_element(locator=locator, parent=parent)
